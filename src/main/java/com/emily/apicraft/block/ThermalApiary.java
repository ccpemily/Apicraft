...
public class ThermalApiary extends AbstractBeeHousingBlock {
    public ThermalApiary() {
        super(BlockBehaviour.Properties.of(Material.METAL).strength(2.0f).requiresCorrectToolForDrops(), ThermalApiaryEntity.class, Registries.TILE_ENTITIES.getSup("thermal_apiary"));
    }
}
