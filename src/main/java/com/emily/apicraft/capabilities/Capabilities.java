...
import com.emily.apicraft.interfaces.capabilities.IFrameDataProvider;
...
public class Capabilities {
    ...
    public static final Capability<IFrameDataProvider> FRAME_DATA_PROVIDER = CapabilityManager.get(new CapabilityToken<>() {});
}
